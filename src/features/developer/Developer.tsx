...
import { Code2, Mail, Phone, MapPin, Globe, ExternalLink, Briefcase, Award, Sparkles, GraduationCap } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1 bg-card/70 backdrop-blur-md border border-border/60 overflow-hidden flex flex-col items-center p-6 text-center">
          ...
          <p className="text-xs font-semibold text-primary mt-1 uppercase tracking-wider">Frontend Web Developer</p>
          <p className="text-[11px] text-muted-foreground mt-1 flex items-center gap-1 justify-center">
            <MapPin className="h-3.5 w-3.5 text-primary shrink-0" /> Dhaka, Bangladesh
          </p>
          ...
          <div className="w-full space-y-3">
            ...
            <a
              href="tel:+8801727244864"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-secondary/40 hover:bg-secondary border border-border/30 hover:border-border/80 transition-all text-xs font-semibold group"
            >
              <Phone className="h-4 w-4 text-primary shrink-0" />
              <span className="truncate flex-1 text-left">+880 1727244864</span>
              <ExternalLink className="h-3.5 w-3.5 text-muted-foreground group-hover:text-foreground shrink-0" />
            </a>
          </div>
        </Card>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-card/45 backdrop-blur-md">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground leading-relaxed">
              <p>
                I am a passionate **Frontend Web Developer** with a strong focus on crafting responsive, pixel-perfect, and modern user experiences. With expert skills in HTML, CSS, JavaScript, and React, I turn ideas into clean and efficient code.
              </p>
              <p>
                My professional experience covers frameworks like **Vue JS** (and wrapper **Nuxt JS**), library **React JS**, and frontend toolkits like **Tailwind CSS**, **Bootstrap**, and **SASS**. I am dedicated to clean code architecture, performance optimization, and client satisfaction.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3.5 text-xs">
                <div>
                  <span className="font-bold text-foreground">BSc in Computer Science & Engineering</span>
                  <p className="text-muted-foreground mt-0.5">Focusing on Software Engineering and Web Architecture.</p>
                </div>
                <div className="pt-2 border-t border-border/40">
                  <span className="font-bold text-foreground">Hobbies</span>
                  <p className="text-muted-foreground mt-0.5">Eat. Sleep. Code. Repeat.</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-xs text-muted-foreground">
                <div className="flex items-start gap-2">
                  ...
                  <span>Responsive Web Design & Layout</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-primary font-bold">•</span>
                  <span>Figma / Sketch / PSD to HTML & React</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-primary font-bold">•</span>
                  <span>WordPress & Shopify Customization</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-primary font-bold">•</span>
                  <span>REST API Integration & Single Page Apps</span>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  'REST APIs', 'Git / GitHub', 'WordPress / Shopify'
                ].map((skill) => (
                  <span
                    key={skill}
