...
export const Reports: React.FC = () => {
  ...
  const billHistory = useMemo(() => {
    ...
    const history: { monthLabel: string; date: string; amount: number; notes: string | null }[] = [];
    expenses.forEach(e => {
    ...
    return history.sort((a, b) => b.monthLabel.localeCompare(a.monthLabel));
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          {/* Bottom Summaries Replicating Joyonto's Google Sheet */}
        ...
        {/* Tab 2: Bill Analyzer (History Log sort/filter by category) */}
          ...
          <Card className="shadow-lg border-border/80 bg-card/65 backdrop-blur-md">
            <CardHeader className="bg-muted/30 border-b border-border/50 py-4 px-5">
              <CardTitle className="text-sm font-bold flex items-center gap-2">
                ...
                Monthly Bill Analyzer
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 pt-4">
              <p className="text-xs text-muted-foreground font-semibold">
                Click on a bill category below to analyze all past payments and invoices logged for it.
              </p>
              ...
              {selectedBillCategory ? (
                ...
                <div className="py-12 text-center text-xs text-muted-foreground border border-dashed rounded-xl">
                  Select a category above to view past invoices list.
                </div>
              )}
            </CardContent>
          </Card>
